$(document).ready(function() {
	...
	Modal = $("#ajax-dialog").dialog({
		autoOpen: false, 
		title: "Processing System Upgrade", 
		modal: true, 
		width: "600",
		buttons: [{
			text: "Close Window", 
    ...
    $("#upgrade").click(function() {
		...
		$("#upgrade").attr("disabled", true).attr('value', 'Please Refresh Window');
		...
		$.ajax({
            ...
            {
                $('.mws-dialog-inner').html('<font color="red">There was an error upgrading the system. Please refresh the page and try again.</font>');
